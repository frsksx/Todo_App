...
Last verified (2026-05-01, after drag/drop hardening and test extension):
...
- Escape first closes any open text box: title editor, note editor, date picker, page rename, or heading editor. Only when nothing is open does it minimize the window.
